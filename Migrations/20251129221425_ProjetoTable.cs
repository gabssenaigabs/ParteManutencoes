        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InicioMandato = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BlocoResidencia = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroApartamento = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    Cargo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    InformacaoVisitante = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProprietarioNome = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocatarioNome = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProprietarioNome = table.Column<string>(type: "nvarchar(max)", nullable: true),
